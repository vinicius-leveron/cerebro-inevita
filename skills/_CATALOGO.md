...
| Skill | Papel |
|---|---|
| `prototipar` | monta o protótipo comercial e de entrega, escolhe a frente e desenha o loop |
| `moldar` | escreve o arquivo de contexto que uma skill de fora lê e valida numa rodada real |
